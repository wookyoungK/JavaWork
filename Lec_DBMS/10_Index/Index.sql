...
SELECT * FROM t_dept2;
CREATE UNIQUE INDEX idx_dept2_dname ON t_dept2(dname); --유니크가 걸리면 중복된값이 들어갈수없다

INSERT INTO t_dept2 VALUES(9100, '임시매장',1006,'서울지사');
INSERT INTO t_dept2 VALUES(9101, '임시매장',1006,'부산지사');
--SQL Error [1] [23000]: ORA-00001: unique constraint (SCOTT0316.IDX_DEPT2_DNAME) violated 유니킁 error
