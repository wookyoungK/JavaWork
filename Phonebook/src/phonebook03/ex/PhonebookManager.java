...
public class PhonebookManager implements Pb {
	...
	public int updateByUid(int uid, String name, String phoneNum, String memo) {
		...
		//return 부분에 throw넣어준것 phonebook2와 비겨ㅛ해보기
		// 매개변수 검증
		if (uid < 1)
	...
	public int deleteByUid(int uid) {
		...
		// 매개변수 검증
		if (uid < 1)
			throw new PhonebookException("deleteByUid() uid오류: " +uid, Pb.ERR_UID);
...
class PhonebookException extends RuntimeException {
	...
	public PhonebookException(String str, int errCode) {
		super(str);
	...
	public String getMessage() {
		String str = "ERR-" + errCode + "]"+Pb.ERR_STR[errCode]+
				" "+ super.getMessage();
		return str;
	}
