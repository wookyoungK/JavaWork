    ...
    <div class="user-modal-container">
        ...
        <div id="login">
            <div class="form">
                ...
                <p class="fieldset">
                    <input class="full-width has-padding has-border" id="u_id" type="id" name="u_id" value="${cookie.user_check.value}" placeholder="ID">
                </p>

                <p class="fieldset">
                    <input class="full-width has-padding has-border" id="u_pw" type="password"  placeholder="Password">
                </p>
...
<!--<div class="user-modal-container">
    <div class="area_inputs wow fadeIn">
        <div class="form-group">
            <p>
                <input class="full-width has-padding has-border" type="text" class="form-control" id="u_id" name="u_id" value="" placeholder="아이디">
            </p>
        </div>
        <div class="form-group">
            <div>
                <input class="full-width has-padding has-border" type="password" class="form-control" id="u_pw" name="u_pw" placeholder="비밀번호">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="interval_height a_none">
                <a href="/user/userSearch">&nbsp; 아이디 / 비밀번호 찾기</a>
            </div>
            <div>
        ...
        <div class="form-group">
            <a class="btn btn-deep-orange btn-block" href="/user/register">회원가입</a>
        </div>
    </div>
</div>-->
<script>
