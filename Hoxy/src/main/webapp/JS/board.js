				...
				function() {
					...
					$.datepicker
							.setDefaults({
								...
								// 변경
								,
								showOtherMonths : true // 빈 공간에 현재월의 앞뒤월의 날짜를
								// 표시
								,
								showMonthAfterYear : true // 년도 먼저 나오고, 뒤에 월
								// 표시
								,
								...
								,
								showOn : "both" // button:버튼을 표시하고,버튼을 눌러야만 달력
								// 표시 ^ both:버튼을 표시하고,버튼을
								...
								// 경로
								,
								buttonImageOnly : true // 기본 버튼의 회색 부분을 없애고,
								// 이미지만 보이게 함
								,
								...
								// Tooltip 텍스트
								,
								minDate : "-1M" // 최소 선택일자(-1D:하루전, -1M:한달전,
								// -1Y:일년전)
								,
								maxDate : "+1M" // 최대 선택일자(+1D:하루후, -1M:한달후,
							// -1Y:일년후)
							});
					...
					$('#datepicker').datepicker('setDate', 'today'); // (-1D:하루전,
					// -1M:한달전,
					// -1Y:일년전), (+1D:하루후,
					// -1M:한달후, -1Y:일년후)
					// To의 초기값을 내일로 설정
					$('#datepicker2').datepicker('setDate', '+1D'); // (-1D:하루전,
					// -1M:한달전,
					// -1Y:일년전), (+1D:하루후,
					// -1M:한달후, -1Y:일년후)
