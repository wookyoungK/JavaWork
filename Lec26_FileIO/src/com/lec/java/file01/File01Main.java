...
4) java.io.Console : 콘솔로부터 문자을 입출력하기 위한 클래스-->안씀
*/
...
public class File01Main {
	...
	public static void main(String[] args) {
		...
		Scanner sc = new Scanner(System.in); //in:inputStream 타입 : 키보드로부터 입력받음  
		sc.close();
		...
		System.out.println("hello"); //out : printStream -->OutputStream
