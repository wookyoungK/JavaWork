...
public class Variable04Main {
	...
	public static void main(String[] args) {
		...
		// char : 문자 하나 를 저장하기 위한 데이터 타입(2바이트)
		char ch1 = 'A';
		// char 리터를은 홀따옴표('')로 묶어줌
		...
		System.out.println("ch7 + 1 : " + (char)(ch7 + 1));//형변환
		...
		//primitive 타입 xx!
		String name = "Kim";
		String name2 = "WooKyoung";
		System.out.println("성은: " +name +"\n이름: "+ name2  );
