...
public class Variable03Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("1.4 x 10 (-45승)");
		System.out.println("float :" + Double.MIN_VALUE + "~" + Double.MAX_VALUE);
		System.out.println("1.4 x 10 (-32승) ~ 1.79~~ x 10(308승) E뒤로 승수");
		...
		//실수 표기법
		double number6 = 123; //123.0 으로 대입됨
		double number7 = 1.23e2; //지수표기법 (10의2승)
		System.out.println("number6= " + number6);
		System.out.println("number7= " + number7);
		
		double number8 = 0.0001213;
		double number9 = 1.213E-4; //(10의 -4승)
