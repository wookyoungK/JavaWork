...
public class Thread01Main {
	...
	public static void main(String[] args) {
		...
		Thread th2 = new MyThread("큐트융두");

		// 4. 생성된 인스턴스에서 start() 메소드를 호출
		th1.start(); //thread를 뽑아내는 메소드 start
		th2.start();
		...
		System.out.println("=======================");
		// 여기에서 총쓰레드는 2개 기본Main ,t1.start하나 
		//메인은 syso가끝나면 끝나고 t1.start는 계속실행후 끝난다
...
class MyThread extends Thread {
	...
	// 쓰레드에서 할 일을 구현
	@Override
	public void run() {//원래 Thread에 있었다ㅃ
		for(int i =0; i<100; i++) {
