...
public class Array01Main {
	...
	public static void main(String[] args) {
		...
		korean[1] = 91; //첫번째 배열원소에 90대입
		korean[2] = 92; //첫번째 배열원소에 90대입
		
		System.out.println("국어0 : " + korean[0]);
		System.out.println("수학1 : " + korean[1]);
		System.out.println("과학2 : " + korean[2]);
		...
		System.out.println();
		// int타입의 english 라는 이름의, 5개 데이터를 담는 배열 선언 ,초기화
		int[] english;
		english = new int[5];
